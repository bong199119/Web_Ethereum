...
<%@ include file="../inc/header.jsp"%>
  		...
  		<div class="modal-dialog" role="document">
    			<div class="modal-content">
		    		<div class="modal-header">
		        		<h5 class="modal-title" id="accountPwdModalLabel">Account (<span id="modalAddress"><%="0xbc05fb621a270bc2512fe701559294c89f39c27b" %></span>)</h5>
	...
	<!-- modal end -->
	<input type="hidden" id="userAddress" value="<%="0xbc05fb621a270bc2512fe701559294c89f39c27b"%>"/>
